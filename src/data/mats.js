export const matsApplication = {
  ...
  content: [
    {
      type: "md",
      content: `[MATS](https://www.matsprogram.org/apply) seemed like a good way to contribute to AI safety research while also learning. I took the application process as an opportunity to get a state of the field. To do so, I read through each stream, and the representative papers I found intruiging.
...
1. <u>Representation Engineering</u>:  An interesting paradigm to be sure. The general concept, taking a high top-down approach to interpretability, seems promising. Common mechanistic interpretability operates on such a low level that I'm convinced it has to miss out on representations hidden at higher levels. One thing this paper doesn't explore is concept representations over a temporal axis - it's concerned with the current state of the model, and averages concepts over many passes. 

2. <u>Lean Agent (formal proof solving)</u>: Training LM to output in a formal language. Progress here would lead to more accurate AI agents (probably a good thing).

3. <u>Distributed Control</u>: Threat evaluation & control over distributed deployments of models - looking for stateless collusion. I hadn't thought of stateless collusion until this. 

4. <u>Belief Geometry in the Residual Stream</u>: Really cool. Results seem to suggest that future context is represented in the residual stream of models - that they're actually planning ahead! I'd like to see this be applied to SAE Interpretability - it's often not clear what SAE circuits or features represent - maybe some of this confusion can be explained by acknowledging that many features are probably pointing at future context.

5. <u>Interpretability in Param Space</u>: Another high-level method of interpreting LLM 'thoughts'.
...
I applied to several streams. I'll share two proposals here. 
 
1. [Proposal for Black-box-monitor scheming environment](https://docs.google.com/document/d/1LqhQrE745_wDas8zSPTB06ZwgDqeagfXpaZamuZHX-I/edit?usp=sharing) (Includes code)
...
Unfortunately for past me I did not get into MATS - but fortunate for you, prospective employer/collaborator/peer :)
